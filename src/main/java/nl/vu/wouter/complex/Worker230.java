...
public class Worker230 extends Worker6 {
    ...
    public int extraWork3(byte[] data) {
        return super.extraWork3(data) + 230;
    }

    @Override
    public int extraWork4(byte[] data) {
        return super.extraWork4(data) + 230;
    }

    @Override
    public int extraWork7(byte[] data) {
        return super.extraWork7(data) + 230;
    }

    @Override
    public int extraWork2(byte[] data) {
        return super.extraWork2(data) + 230;
    }

    @Override
    public int extraWork15(byte[] data) {
        return super.extraWork15(data) + 230;
    }

    @Override
    public int extraWork12(byte[] data) {
        return super.extraWork12(data) + 230;
    }
    ...
    public int uniqueMethod230_0(byte[] data) {
        return data.length * 230;
    }

    public int uniqueMethod230_1(byte[] data) {
        return data.length * 231;
    }

    public static int staticWork(byte[] data) {
        return data.length + 461;
    }
