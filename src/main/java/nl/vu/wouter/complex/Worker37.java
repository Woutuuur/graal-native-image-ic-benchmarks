...
public class Worker37 extends Worker81 {
    ...
    public int uniqueMethod37_0(byte[] data) {
        return data.length * 37;
    }

    public int uniqueMethod37_1(byte[] data) {
        return data.length * 38;
    }

    public int uniqueMethod37_2(byte[] data) {
