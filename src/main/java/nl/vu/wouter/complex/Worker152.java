...
public class Worker152 extends Worker212 {
    ...
    public int uniqueMethod152_0(byte[] data) {
        return data.length * 152;
    }

    public int uniqueMethod152_1(byte[] data) {
        return data.length * 153;
    }

    public static int staticWork(byte[] data) {
        return data.length + 305;
    }
