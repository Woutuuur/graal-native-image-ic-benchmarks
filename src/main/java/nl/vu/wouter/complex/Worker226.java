...
public class Worker226 extends AbstractWorker implements Worker {
    ...
    public int uniqueMethod226_0(byte[] data) {
        return data.length * 226;
    }

    public int uniqueMethod226_1(byte[] data) {
        return data.length * 227;
    }

    public static int staticWork(byte[] data) {
        return data.length + 453;
    }
