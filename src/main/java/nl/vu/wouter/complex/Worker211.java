...
public class Worker211 extends Worker101 {
    ...
    public int extraWork3(byte[] data) {
        return super.extraWork3(data) + 211;
    }

    @Override
    public int extraWork10(byte[] data) {
        return super.extraWork10(data) + 211;
    }

    @Override
    public int extraWork5(byte[] data) {
        return super.extraWork5(data) + 211;
    }

    @Override
    public int extraWork14(byte[] data) {
        return super.extraWork14(data) + 211;
    }

    @Override
    public int extraWork17(byte[] data) {
        return super.extraWork17(data) + 211;
    }
    ...
    public int uniqueMethod211_0(byte[] data) {
        return data.length * 211;
    }

    public int uniqueMethod211_1(byte[] data) {
        return data.length * 212;
    }

    public int uniqueMethod211_2(byte[] data) {
        return data.length * 213;
    }

    public static int staticWork(byte[] data) {
        return data.length + 423;
    }
