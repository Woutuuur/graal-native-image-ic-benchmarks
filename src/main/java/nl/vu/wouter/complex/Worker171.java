...
public class Worker171 extends Worker14 {

    @Override
    public int extraWork6(byte[] data) {
        return super.extraWork6(data) + 171;
    }

    @Override
    public int extraWork1(byte[] data) {
        return super.extraWork1(data) + 171;
    }

    @Override
    public int extraWork19(byte[] data) {
        return super.extraWork19(data) + 171;
    }

    @Override
    public int extraWork8(byte[] data) {
        return super.extraWork8(data) + 171;
    }

    @Override
    public int extraWork3(byte[] data) {
        return super.extraWork3(data) + 171;
    }

    @Override
    public int extraWork13(byte[] data) {
        return super.extraWork13(data) + 171;
    }

    @Override
    public int extraWork11(byte[] data) {
        return super.extraWork11(data) + 171;
    }

    @Override
    public int extraWork17(byte[] data) {
        return super.extraWork17(data) + 171;
    }

    @Override
    public int extraWork4(byte[] data) {
        return super.extraWork4(data) + 171;
    }

    @Override
    public int extraWork10(byte[] data) {
        return super.extraWork10(data) + 171;
    }

    @Override
    public int extraWork5(byte[] data) {
        return super.extraWork5(data) + 171;
    }

    @Override
    public int extraWork14(byte[] data) {
        return super.extraWork14(data) + 171;
    }

    @Override
    public int extraWork9(byte[] data) {
        return super.extraWork9(data) + 171;
    }

    @Override
    public int extraWork18(byte[] data) {
        return super.extraWork18(data) + 171;
    }

    @Override
    public int extraWork2(byte[] data) {
        return super.extraWork2(data) + 171;
    }

    @Override
    public int extraWork16(byte[] data) {
        return super.extraWork16(data) + 171;
    }

    @Override
    public int extraWork15(byte[] data) {
        return super.extraWork15(data) + 171;
    }

    @Override
    public int extraWork12(byte[] data) {
        return super.extraWork12(data) + 171;
    }
    ...
    public int abstractExtraWork1(byte[] data) {
        return data.length * 221;
    }

    @Override
    public int abstractExtraWork18(byte[] data) {
        return data.length * 222;
    }
    ...
    public int uniqueMethod171_0(byte[] data) {
        return data.length * 171;
    }

    public int uniqueMethod171_1(byte[] data) {
